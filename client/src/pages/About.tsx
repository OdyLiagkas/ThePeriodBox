  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full text-sm font-medium text-purple-600">
          <Instagram className="h-4 w-4" />
          Follow Our Journey
        </div>
        <p className="text-muted-foreground">@the_period_box</p>
      </div>
      {/* Added wrapper div with special class */}
